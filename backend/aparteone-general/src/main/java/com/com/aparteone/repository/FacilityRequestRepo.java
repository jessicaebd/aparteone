...
@Repository
public interface FacilityRequestRepo extends JpaRepository<FacilityRequest, Integer> {
    public Page<FacilityRequest> findByResidentId(Integer residentId, Pageable pageable);
